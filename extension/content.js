...
var updatePillContent = function updatePillContent(pill, isLoading, clickbaitResponse, article) {
...
function updateFakeNewsTooltip(tooltip, fakeNewsResponse) {
  ...
  if (fakeNewsResponse) {
    fakeNewsDiv.innerHTML = "\n            <div style=\"\n                margin-top: 10px;\n                padding-top: 10px;\n                border-top: 1px solid #eee;\n            \">\n                <div style=\"\n                    font-weight: bold;\n                    line-height: 1.6;\n                    color: ".concat(fakeNewsResponse.veracity === "Fake News" ? "#ff4d4f" : fakeNewsResponse.veracity === "Real News" ? "#52c41a" : "#faad14", ";\n                    text-align: center;\n                    font-size: 18px;\n                    padding: 8px 0;\n                    margin-bottom: 10px;\n                    border-radius: 6px;\n                    background-color: ").concat(fakeNewsResponse.veracity === "Fake News" ? "#fff2f0" : fakeNewsResponse.veracity === "Real News" ? "#f6ffed" : "#fff7e6", ";\n                \">").concat(fakeNewsResponse.veracity, "</div>\n                <div style=\"margin-top: 8px; line-height: 1.5;\">").concat(fakeNewsResponse.reasoning, "</div>\n                ").concat(fakeNewsResponse.sources ? "\n                <div style=\"margin-top: 12px;\">\n                    <strong>Sources:</strong>\n                    <ol style=\"margin: 6px 0 0 20px; padding: 0; line-height: 1.5;\">\n                        ".concat(fakeNewsResponse.sources.map(function (source) {
