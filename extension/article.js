...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "isArticlePage": () => (/* binding */ isArticlePage)
/* harmony export */ });
...
/* harmony import */ var _fakeNews__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fakeNews */ "./src/fakeNews.js");
...
function updatePillContent(pill, isLoading, response) {
  ...
  var pillText = response.veracity || 'Unknown';
  pill.style.backgroundColor = response.veracity === 'Real News' ? '#52c41a' : response.veracity === 'Fake News' ? '#ff4d4f' : '#faad14';
  pill.style.color = '#fff';
  var tooltip = document.createElement('div');
  tooltip.style = "\n        position: absolute;\n        top: 100%;\n        right: 0;\n        margin-top: 8px;\n        background: white;\n        padding: 12px;\n        border-radius: 8px;\n        box-shadow: 0 2px 8px rgba(0,0,0,0.15);\n        width: 360px;\n        max-height: 500px;\n        display: none;\n        z-index: 10001;\n        font-size: 14px;\n        color: #333;\n        overflow-y: auto;\n        overflow-x: hidden;\n        cursor: default;\n    ";
  pill.innerHTML = "<span>".concat(pillText, "</span>");
  if (!isLoading && response) {
    tooltip.innerHTML = "\n            <div style=\"margin-bottom: 8px; line-height: 1.6;\">\n                <strong>Analysis:</strong> ".concat(response.reasoning, "\n            </div>\n        ");
...
function isArticlePage() {
  var article = new _mozilla_readability__WEBPACK_IMPORTED_MODULE_0__.Readability(document.cloneNode(true)).parse();
...
function _main() {
  _main = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, genAI, model, article, pill, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 5:
          ...
          return _context.abrupt("return");
        case 9:
          genAI = new _google_generative_ai__WEBPACK_IMPORTED_MODULE_2__.GoogleGenerativeAI(response.apiKey);
          model = genAI.getGenerativeModel({
            model: "gemini-2.0-flash"
          });
          window.currentModel = model;
          article = new _mozilla_readability__WEBPACK_IMPORTED_MODULE_0__.Readability(document.cloneNode(true)).parse();
          if (article) {
            _context.next = 15;
            break;
          }
          return _context.abrupt("return");
        case 15:
          pill = createNewsVeracityPill();
          document.body.appendChild(pill);
          updatePillContent(pill, true);
          _context.next = 20;
          return (0,_fakeNews__WEBPACK_IMPORTED_MODULE_1__.checkFakeNews)(article.textContent);
        case 20:
          res = _context.sent;
        ...
        case 24:
          ...
          console.error('Error in article analysis:', _context.t0);
        case 27:
        case "end":
          return _context.stop();
      }
